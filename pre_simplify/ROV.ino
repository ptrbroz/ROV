...
void loop() {
  ...
  int leftDiff = LEFT_TARGET - LEFT_SPEED;
  int rightDiff = RIGHT_TARGET - RIGHT_SPEED;

  if(leftDiff > TOLERANCE){
    LEFT_SPEED += ACCELERATION;
  }
  else if(leftDiff < -TOLERANCE){
    LEFT_SPEED -= ACCELERATION;
  }
  else{
  ...
  if(rightDiff > TOLERANCE){
    RIGHT_SPEED += ACCELERATION;
  }
  else if(rightDiff < -TOLERANCE){
    RIGHT_SPEED -= ACCELERATION;
  }
  else{
